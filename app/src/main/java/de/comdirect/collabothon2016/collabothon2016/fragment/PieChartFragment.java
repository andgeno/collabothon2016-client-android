...
public class PieChartFragment extends Fragment implements OnChartValueSelectedListener {
    ...
    public TextView selectedPiePiece;
...
//        Toast.makeText(getContext(), "Value Selected", Toast.LENGTH_SHORT).show();
        selectedPiePiece.setText("Value: " + e.getY() + ", index: " + h.getX() + ", DataSet index: " + h.getDataSetIndex());
        PieEntry pe = (PieEntry) e;
        selectedPiePiece.setText(pe.getLabel());
    }
    ...
    private void setData(int count, float range) {
        ...
        PieDataSet dataSet = new PieDataSet(entries, ""); // Beschriftung unter der Legende
...
//            colors.add(c);
    ...
    private void setupPieChart() {
        Log.e(BuildConfig.LOG_TAG, "setup pie chart ....");
